...
-(id)initWithFrame:(CGRect)frame{
    if ([super initWithFrame:frame]) {
        _lineWidth = 20;
        _angle = 280;
        radius = self.frame.size.width/2 - _lineWidth/2 - _lineWidth;
...
- (void)drawRect:(CGRect)rect {
    ...
    [RGBA(255, 255, 255, 0.5) setStroke];
    ...
    CGContextSetShadowWithColor(context, CGSizeMake(0, 0), 3,[UIColor grayColor].CGColor);
    [[UIColor whiteColor] setStroke];
    CGContextSetLineWidth(context, _lineWidth);
